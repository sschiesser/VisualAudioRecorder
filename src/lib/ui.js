export function buildUI(){
  ...
  const labCh = $("label", {}, "Channels: ",
    (()=>{
      const sel = $("select", { id: "channels" });
      [1,2,3,4].forEach(v=>{ const o=document.createElement("option"); o.value=String(v); o.text=String(v); if(v===2) o.selected=true; sel.appendChild(o) });
      return sel;
    })()
  );

  const labFFT = $("label", {}, "FFT: ",
    (()=>{
      const sel = $("select", { id: "fft" });
      [512,1024,2048,4096,8192].forEach(v=>{ const o=document.createElement("option"); o.value=String(v); o.text=String(v); if(v===1024) o.selected=true; sel.appendChild(o) });
      return sel;
    })()
  );

  const labBuf = $("label", {}, "Buffer: ",
    (()=>{
      const sel = $("select", { id: "bufferSec" });
      [[30,"30"],[60,"60"],[120,"120"],[300,"300 (5m)"]].forEach(([v,t])=>{ const o=document.createElement("option"); o.value=String(v); o.text=t; if(v===120) o.selected=true; sel.appendChild(o) });
      return sel;
    })()
  );
